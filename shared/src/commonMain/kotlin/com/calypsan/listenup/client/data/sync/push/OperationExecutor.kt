        ...
        fun create(
            ...
            OperationExecutor(
                mapOf(
                    ...
                    OperationType.DISCARD_PROGRESS to discardProgressHandler,
                    OperationType.RESTART_BOOK to restartBookHandler,
                    OperationType.END_PLAYBACK_SESSION to endPlaybackSessionHandler,
