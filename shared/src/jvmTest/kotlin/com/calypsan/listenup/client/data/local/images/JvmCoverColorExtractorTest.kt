...
class JvmCoverColorExtractorTest {
    ...
    @Test
    fun `extracts dominant color from solid red image`() = runTest {
    ...
    @Test
    fun `extracts dominant color from solid blue image`() = runTest {
    ...
    @Test
    fun `extracts colors from two-tone image`() = runTest {
    ...
    @Test
    fun `returns null for empty byte array`() = runTest {
        // When
    ...
    @Test
    fun `returns null for invalid image data`() = runTest {
    ...
    @Test
    fun `handles very small image`() = runTest {
    ...
    @Test
    fun `handles large image efficiently`() = runTest {
    ...
    @Test
    fun `vibrant color has high saturation`() = runTest {
        // Given - image with saturated colors
        val imageBytes = createTwoToneImage(
    ...
    @Test
    fun `dark muted color has low brightness`() = runTest {
    ...
    @Test
    fun `colors are valid ARGB integers`() = runTest {
        // Given
    ...
    @Test
    fun `handles PNG format`() = runTest {
        // Given - PNG image
    ...
    @Test
    fun `handles JPEG format`() = runTest {
        // Given - JPEG image
