...
class JvmSecureStorageTest {
    ...
    @Test
    fun `save and read round-trip works`() = runTest {
        // When
    ...
    @Test
    fun `save overwrites existing value`() = runTest {
        // Given
    ...
    @Test
    fun `multiple keys stored independently`() = runTest {
        // When
    ...
    @Test
    fun `delete removes specific key`() = runTest {
        // Given
    ...
    @Test
    fun `clear deletes storage file`() = runTest {
        // Given
    ...
    @Test
    fun `handles long values`() = runTest {
    ...
    @Test
    fun `handles special JSON characters in values`() = runTest {
    ...
    @Test
    fun `file content is encrypted not plaintext`() = runTest {
        // Given
    ...
    @Test
    fun `delete on non-existent key does not crash`() = runTest {
        // When/Then - should not throw
        storage.delete("nonexistent_key")
    }

    @Test
    fun `new storage on non-existent file works`() = runTest {
        // Given
