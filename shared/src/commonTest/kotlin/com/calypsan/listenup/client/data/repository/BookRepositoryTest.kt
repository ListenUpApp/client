...
class BookRepositoryTest {
    ...
    private class TestFixture {
        ...
        fun build(): BookRepository = BookRepository(
            bookDao = bookDao,
    ...
    @Test
    fun `observeBooks returns empty list when no books`() = runTest {
        // Given
    ...
    @Test
    fun `observeBooks transforms entities to domain models`() = runTest {
        // Given
        ...
        val bookWithContributors = BookWithContributors(
            book = bookEntity,
    ...
    @Test
    fun `observeBooks includes cover path when image exists`() = runTest {
        // Given
    ...
    @Test
    fun `observeBooks excludes cover path when image does not exist`() = runTest {
        // Given
        val bookEntity = createTestBookEntity(id = "book-1")
        val bookWithContributors = BookWithContributors(
            book = bookEntity,
    ...
    @Test
    fun `observeBooks includes authors from contributors with author role`() = runTest {
        // Given
        val bookEntity = createTestBookEntity(id = "book-1")
        val author = createTestContributor(id = "author-1", name = "Stephen King")
        val crossRef = BookContributorCrossRef(
        ...
        assertEquals("Stephen King", result.first().authors.first().name)
    }

    @Test
    fun `observeBooks includes narrators from contributors with narrator role`() = runTest {
        // Given
        val bookEntity = createTestBookEntity(id = "book-1")
        ...
        assertEquals("Morgan Freeman", result.first().narrators.first().name)
    }

    @Test
    fun `observeBooks handles contributor with multiple roles`() = runTest {
        // Given - same person is both author and narrator
        val bookEntity = createTestBookEntity(id = "book-1")
        val contributor = createTestContributor(id = "person-1", name = "Neil Gaiman")
        val authorRole = BookContributorCrossRef(
            bookId = BookId("book-1"),
            contributorId = "person-1",
            role = "author",
        )
        val narratorRole = BookContributorCrossRef(
            bookId = BookId("book-1"),
            contributorId = "person-1",
            role = "narrator",
        )
        ...
        assertTrue(book.allContributors.first().roles.containsAll(listOf("author", "narrator")))
    }

    @Test
    fun `observeBooks includes multiple authors and narrators`() = runTest {
        // Given
        val bookEntity = createTestBookEntity(id = "book-1")
    ...
    @Test
    fun `refreshBooks delegates to syncManager`() = runTest {
        // Given
        val fixture = createFixture()
    ...
    @Test
    fun `refreshBooks returns success when sync succeeds`() = runTest {
        // Given
        val fixture = createFixture()
        everySuspend { fixture.syncManager.sync() } returns Result.Success(Unit)
        val repository = fixture.build()
    ...
    @Test
    fun `refreshBooks returns failure when sync fails`() = runTest {
        // Given
        val fixture = createFixture()
    ...
    @Test
    fun `getBook returns null when not found`() = runTest {
        // Given
        val fixture = createFixture()
    ...
    @Test
    fun `getBook transforms entity to domain model`() = runTest {
        // Given
        val bookEntity = createTestBookEntity(
            id = "book-1",
            title = "Found Book",
    ...
    @Test
    fun `getBook includes cover path when image exists`() = runTest {
        // Given
        val bookEntity = createTestBookEntity(id = "book-1")
        val bookWithContributors = BookWithContributors(
            book = bookEntity,
    ...
    @Test
    fun `getChapters returns existing chapters from database`() = runTest {
        // Given
        val chapters = listOf(
    ...
    @Test
    fun `getChapters generates mock chapters when database empty`() = runTest {
        // Given
        val fixture = createFixture()
    ...
    @Test
    fun `getChapters persists mock chapters to database`() = runTest {
        // Given
        val fixture = createFixture()
        everySuspend { fixture.chapterDao.getChaptersForBook(BookId("book-1")) } returns emptyList()
        everySuspend { fixture.chapterDao.upsertAll(any()) } returns Unit
    ...
    @Test
    fun `getChapters transforms chapter entities to domain models`() = runTest {
        // Given
