...
class LensUseCasesTest {
    ...
    @Test
    fun `create lens returns success with valid name`() = runTest {
        // Given
    ...
    @Test
    fun `create lens calls repository with trimmed name`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
    ...
    @Test
    fun `create lens returns validation error for blank name`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
        val useCase = CreateLensUseCase(lensRepository)
    ...
    @Test
    fun `create lens returns validation error for empty name`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
        val useCase = CreateLensUseCase(lensRepository)
    ...
    @Test
    fun `create lens passes description to repository`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
        everySuspend { lensRepository.createLens(any(), any()) } returns createLens()
        val useCase = CreateLensUseCase(lensRepository)
    ...
    @Test
    fun `create lens converts empty description to null`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
        everySuspend { lensRepository.createLens(any(), any()) } returns createLens()
        val useCase = CreateLensUseCase(lensRepository)
    ...
    @Test
    fun `create lens returns failure on repository error`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
    ...
    @Test
    fun `update lens returns success with valid name`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
    ...
    @Test
    fun `update lens calls repository with correct parameters`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
    ...
    @Test
    fun `update lens returns validation error for blank name`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
        val useCase = UpdateLensUseCase(lensRepository)
    ...
    @Test
    fun `update lens trims name before repository call`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
        everySuspend { lensRepository.updateLens(any(), any(), any()) } returns createLens()
        val useCase = UpdateLensUseCase(lensRepository)
    ...
    @Test
    fun `update lens converts empty description to null`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
        everySuspend { lensRepository.updateLens(any(), any(), any()) } returns createLens()
        val useCase = UpdateLensUseCase(lensRepository)
    ...
    @Test
    fun `update lens returns failure on repository error`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
    ...
    @Test
    fun `delete lens returns success`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
    ...
    @Test
    fun `delete lens calls repository with correct ID`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
        everySuspend { lensRepository.deleteLens(any()) } returns Unit
        val useCase = DeleteLensUseCase(lensRepository)
    ...
    @Test
    fun `delete lens returns failure on repository error`() = runTest {
        // Given
        val lensRepository: LensRepository = mock()
