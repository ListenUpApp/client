...
class TestMockEngineTest {
    @Test
    fun dispatchesJsonResponseForRegisteredPath() = runTest {
    ...
    @Test
    fun returns404ForUnregisteredPath() = runTest {
        val client = HttpClient(
            testMockEngine {
    ...
    @Test
    fun respondJsonIncludesContentTypeHeader() = runTest {
        val client = HttpClient(
            testMockEngine {
    ...
    @Test
    fun respondStatusEmitsRequestedStatusCode() = runTest {
        val client = HttpClient(
            testMockEngine {
