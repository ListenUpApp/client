...
class HomeRepositoryTest {
    ...
    private class TestFixture {
        ...
        fun build(): HomeRepository = HomeRepository(
    ...
    @Test
    fun `getContinueListening returns empty list when no positions`() = runTest {
        // Given
    ...
    @Test
    fun `getContinueListening returns books with correct progress`() = runTest {
        // Given
        val fixture = createFixture()
    ...
    @Test
    fun `getContinueListening filters out books not found in repository`() = runTest {
        // Given
        val fixture = createFixture()
    ...
    @Test
    fun `getContinueListening filters out completed books (99%+)`() = runTest {
        // Given
        val fixture = createFixture()
    ...
    @Test
    fun `getContinueListening includes books at 98% progress`() = runTest {
        // Given
        val fixture = createFixture()
    ...
    @Test
    fun `getContinueListening handles zero duration book`() = runTest {
        // Given
        val fixture = createFixture()
        val position = createPlaybackPosition("book-1", positionMs = 5000L)
    ...
    @Test
    fun `getContinueListening includes author names`() = runTest {
        // Given
        val fixture = createFixture()
        val position = createPlaybackPosition("book-1", positionMs = 5000L)
    ...
    @Test
    fun `getContinueListening includes cover path`() = runTest {
        // Given
        val fixture = createFixture()
        val position = createPlaybackPosition("book-1", positionMs = 5000L)
    ...
    @Test
    fun `getContinueListening respects limit parameter`() = runTest {
        // Given
        val fixture = createFixture()
    ...
    @Test
    fun `observeCurrentUser returns user from userDao`() = runTest {
        // Given
        val fixture = createFixture()
    ...
    @Test
    fun `observeCurrentUser returns null when no user`() = runTest {
        // Given
        val fixture = createFixture()
