...
class SyncStatusRepositoryImplTest {
    ...
    @Test
    fun `getLastSyncTime returns timestamp when sync time exists`() = runTest {
        // Given
    ...
    @Test
    fun `getLastSyncTime returns null when sync time does not exist`() = runTest {
        // Given
        val dao = createMockDao()
    ...
    @Test
    fun `getLastSyncTime returns null for invalid stored value`() = runTest {
    ...
    @Test
    fun `getLastSyncTime returns null for empty string value`() = runTest {
        // Given
        val dao = createMockDao()
    ...
    @Test
    fun `getLastSyncTime calls dao with correct key`() = runTest {
        // Given
        val dao = createMockDao()
    ...
    @Test
    fun `setLastSyncTime stores timestamp as string`() = runTest {
        // Given
        val dao = createMockDao()
    ...
    @Test
    fun `setLastSyncTime handles zero timestamp`() = runTest {
    ...
    @Test
    fun `setLastSyncTime handles large timestamp value`() = runTest {
    ...
    @Test
    fun `clearLastSyncTime calls dao delete with correct key`() = runTest {
        // Given
        val dao = createMockDao()
        val repository = SyncStatusRepositoryImpl(dao)
    ...
    @Test
    fun `clearLastSyncTime does not throw when no sync time exists`() = runTest {
    ...
    @Test
    fun `getLastSyncTime handles negative timestamp value`() = runTest {
    ...
    @Test
    fun `getLastSyncTime handles whitespace-only value`() = runTest {
