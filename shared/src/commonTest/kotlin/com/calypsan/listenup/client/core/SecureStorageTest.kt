...
class SecureStorageTest {
    ...
    @Test
    fun `save stores key-value pair`() = runTest {
        // Given
    ...
    @Test
    fun `read returns stored value`() = runTest {
        // Given
        val storage = mock<SecureStorage>()
    ...
    @Test
    fun `delete does not affect other keys`() = runTest {
        // Given
        val storage = mock<SecureStorage>()
    ...
    @Test
    fun `empty string can be stored as value`() = runTest {
        // Given
        val storage = mock<SecureStorage>()
    ...
    @Test
    fun `long values can be stored`() = runTest {
        // Given
