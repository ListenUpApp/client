...
class CollectionUseCasesTest {
    ...
    @Test
    fun `create collection returns success with valid name`() = runTest {
        // Given
    ...
    @Test
    fun `create collection calls repository with trimmed name`() = runTest {
        // Given
        val repository: CollectionRepository = mock()
    ...
    @Test
    fun `create collection returns validation error for blank name`() = runTest {
        // Given
        val repository: CollectionRepository = mock()
        val useCase = CreateCollectionUseCase(repository)
    ...
    @Test
    fun `create collection returns validation error for empty name`() = runTest {
        // Given
        val repository: CollectionRepository = mock()
        val useCase = CreateCollectionUseCase(repository)
    ...
    @Test
    fun `create collection returns failure on repository error`() = runTest {
        // Given
        val repository: CollectionRepository = mock()
    ...
    @Test
    fun `delete collection returns success`() = runTest {
        // Given
        val repository: CollectionRepository = mock()
    ...
    @Test
    fun `delete collection calls repository with correct ID`() = runTest {
        // Given
        val repository: CollectionRepository = mock()
        everySuspend { repository.delete(any()) } returns Unit
        val useCase = DeleteCollectionUseCase(repository)
    ...
    @Test
    fun `delete collection returns failure on repository error`() = runTest {
        // Given
        val repository: CollectionRepository = mock()
