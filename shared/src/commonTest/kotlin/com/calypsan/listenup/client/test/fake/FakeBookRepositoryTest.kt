...
class FakeBookRepositoryTest {
    @Test
    fun observeBooksEmitsSeededThenUpdated() = runTest {
    ...
    @Test
    fun getBookLooksUpById() = runTest {
    ...
    @Test
    fun getBooksReturnsOnlyMatchingIds() = runTest {
    ...
    @Test
    fun refreshBooksSucceedsAndCountsCalls() = runTest {
    ...
    @Test
    fun chaptersRoundTripThroughSetChapters() = runTest {
        val repo = FakeBookRepository()
    ...
    @Test
    fun observeRecentlyAddedBooksOrdersByAddedAtDescending() = runTest {
        val older = TestData.book(id = "older").copy(addedAt = com.calypsan.listenup.client.core.Timestamp(epochMillis = 1_000L))
        val newer = TestData.book(id = "newer").copy(addedAt = com.calypsan.listenup.client.core.Timestamp(epochMillis = 2_000L))
