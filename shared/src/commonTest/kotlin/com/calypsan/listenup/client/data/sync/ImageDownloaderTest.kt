...
class ImageDownloaderTest {
    ...
    private class TestFixture {
        ...
        fun build(): ImageDownloader = ImageDownloader(
            imageApi = imageApi,
    ...
    @Test
    fun `downloadCover returns success with true when cover downloaded and saved`() = runTest {
        // Given
    ...
    @Test
    fun `downloadCover returns success with false when cover already exists`() = runTest {
        // Given
        val fixture = createFixture()
        val bookId = BookId("book-1")
    ...
    @Test
    fun `downloadCover returns success with false when API returns failure`() = runTest {
    ...
    @Test
    fun `downloadCover returns failure when storage save fails`() = runTest {
        // Given
        val fixture = createFixture()
        val bookId = BookId("book-1")
    ...
    @Test
    fun `downloadCover does not call API when cover already exists`() = runTest {
        // Given
        val fixture = createFixture()
        val bookId = BookId("book-1")
        every { fixture.imageStorage.exists(bookId) } returns true
    ...
    @Test
    fun `downloadCovers returns list of successfully downloaded book IDs`() = runTest {
        // Given
        val fixture = createFixture()
    ...
    @Test
    fun `downloadCovers excludes already existing covers from result`() = runTest {
        // Given
        val fixture = createFixture()
        val book1 = BookId("book-1")
        val book2 = BookId("book-2")
    ...
    @Test
    fun `downloadCovers continues on individual failures`() = runTest {
        // Given
        val fixture = createFixture()
        val book1 = BookId("book-1")
        val book2 = BookId("book-2")
    ...
    @Test
    fun `downloadCovers returns empty list when all downloads fail`() = runTest {
        // Given
        val fixture = createFixture()
        val book1 = BookId("book-1")
        val book2 = BookId("book-2")
    ...
    @Test
    fun `downloadCovers handles empty list`() = runTest {
        // Given
        val fixture = createFixture()
        val imageDownloader = fixture.build()
