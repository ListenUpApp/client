...
class FakeSessionRepositoryTest {
    private fun reader(userId: String) = ReaderInfo(
        userId = userId,
        displayName = userId,
        avatarColor = "#000000",
    ...
    @Test
    fun seededReadersAreReturnedByGetBookReaders() = runTest {
        val seed = mapOf(
            "book-1" to BookReadersResult(
    ...
    @Test
    fun setReadersUpdatesObservers() = runTest {
    ...
    @Test
    fun refreshBookReadersIncrementsRefreshCount() = runTest {
        val repo = FakeSessionRepository()
    ...
    @Test
    fun getBookReadersResultReturnsSuccess() = runTest {
        val seed = mapOf(
            "book-1" to BookReadersResult(
                yourSessions = emptyList(),
